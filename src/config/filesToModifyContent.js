  ...
  return [
    ...
    },
    {
      ...
      paths: [
        ...
        `ios/${nS_NewProjectName}.xcodeproj/xcshareddata/xcschemes/${nS_NewProjectName}-tvOS.xcscheme`,
        `ios/${nS_NewProjectName}.xcodeproj/xcshareddata/xcschemes/${nS_NewProjectName}.xcscheme`,
